...
En este repositorio se presentan las actividades prácticas desarrolladas durante los laboratorios de la asignatura de Ciberseguridad, utilizando entornos virtualizados con Kali Linux y Ubuntu Server.

Las experiencias realizadas permitieron aplicar conceptos relacionados con criptografía, autenticación multifactor, análisis de tráfico y protección de servicios mediante herramientas utilizadas en entornos reales de seguridad informática.
...
Los laboratorios desarrollados permitieron comprender de manera práctica distintas técnicas utilizadas en ciberseguridad ofensiva y defensiva.

Durante las actividades se trabajó con herramientas como OpenSSL, Hydra, Wireshark y SSH, aplicando procedimientos relacionados con integridad de datos, firmas digitales, ataques de credenciales y protección de comunicaciones.

Además, fue posible analizar cómo mecanismos como MFA y túneles SSH ayudan a fortalecer la seguridad de los sistemas y proteger información sensible frente a posibles ataques.

La realización de estos laboratorios permitió reforzar conocimientos técnicos sobre protección de datos y administración segura de servicios en red.
